...
# define POLYBENCH_ALLOC_1D_ARRAY(n1, type)	\
  (type(*)[(unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR])polybench_alloc_data ((unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR, sizeof(type))
# define POLYBENCH_ALLOC_2D_ARRAY(n1, n2, type)		\
  (type(*)[(unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n2) + POLYBENCH_PADDING_FACTOR])polybench_alloc_data (((unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n2) + POLYBENCH_PADDING_FACTOR), sizeof(type))
# define POLYBENCH_ALLOC_3D_ARRAY(n1, n2, n3, type)		\
  (type(*)[(unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n2) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n3) + POLYBENCH_PADDING_FACTOR])polybench_alloc_data (((unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n2) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n3) + POLYBENCH_PADDING_FACTOR), sizeof(type))
# define POLYBENCH_ALLOC_4D_ARRAY(n1, n2, n3, n4, type)			\
  (type(*)[(unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n2) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n3) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n4) + POLYBENCH_PADDING_FACTOR])polybench_alloc_data (((unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n2) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n3) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n4) + POLYBENCH_PADDING_FACTOR), sizeof(type))
# define POLYBENCH_ALLOC_5D_ARRAY(n1, n2, n3, n4, n5, type)		\
  (type(*)[(unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n2) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n3) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n4) + POLYBENCH_PADDING_FACTOR][(unsigned long long int )(n5) + POLYBENCH_PADDING_FACTOR])polybench_alloc_data (((unsigned long long int )(n1) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n2) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n3) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n4) + POLYBENCH_PADDING_FACTOR) * ((unsigned long long int )(n5) + POLYBENCH_PADDING_FACTOR), sizeof(type))
...
extern double polybench_get_timer();
# if true
#  undef polybench_start_instruments
#  undef polybench_stop_instruments
#  undef polybench_print_instruments
